    ...
    <div class="col-md-6 col-md-6 col-sm-6">
        ...
        <script>
            ...
            function get_element() {
                $.post( "ajax/get_soilmo.php?last=true", function( data ) {
                    soil = data;
                });
            }       
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Live Soil Moisture</h3>
            </div>
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM soilmoist ORDER BY id DESC LIMIT 10";
                        $result = mysqli_query($con, $query);  
...
<div class="row hide" id="stat_graph">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM soilmoist ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
...
<script>      
	...
	{
	  $('#attending_tbl').load('ajax/one_day_soilmo.php');
	}
    ...
    function get_day_stat(){
        $.ajax({
            ...
            success: function(data){
                ...
                console.log(vals[3]);
                console.log(vals[4]);
                document.getElementById("min_moist").innerHTML = vals[0]+"%";
                document.getElementById("min_time").innerHTML = vals[1];
                document.getElementById("max_moist").innerHTML = vals[2]+"%";
                document.getElementById("max_time").innerHTML = vals[3];
                document.getElementById("ave_moist").innerHTML = vals[4]+"%";
                }
        });
    }
