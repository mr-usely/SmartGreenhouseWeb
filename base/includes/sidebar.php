<div id="sidebar-wrapper">  
    <div class="user-panel">
        ...
        <div class="slogan pull-left">
            <h3 class="pull-right">Web-Based Eggplant</h3>
            <br>
            <h5 class="pull-right">Monitoring System Using Arduino Mega</h5>
        </div>
    </div>
    <ul class="sidebar-nav">
        <?php
            ...
            if($con && $module == "base" && $_SESSION['username']=="admin"){
				echo "<li "; if($module == "base" && $menu=="dash") echo 'id="active"'; echo '>';
                    echo '<a href="index.php?mod=base&menu=dash"><span class="glyphicon glyphicon-blackboard"></span>&nbsp; Dashboard</a>';
                echo "</li>";
        ...
        <?php
            ...
            if($con && $module != "base"){
                ...
                while($row = mysqli_fetch_assoc($result)){
                    echo "<li "; if($menu=="dashboard") echo 'id="active"'; echo '>';
						echo '<a href="?mod='. $module .'&menu=dashboard"><span class="glyphicon glyphicon-blackboard"></span>&nbsp; Dashboard</a>';
					echo "</li>";
