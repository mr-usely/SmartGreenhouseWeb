...
// GET MIN VALUE, DATE
$query = "SELECT value, date FROM waterlevel WHERE date BETWEEN '{$start}' AND '{$end}'";
...
// GET AVERAGE
$query = "SELECT AVG(value) AS ave FROM waterlevel WHERE date BETWEEN '{$start}' AND '{$end}'";
$result = mysqli_query($con, $query);
